...
Fix: enqueue cleanup on the existing queue, return `202` with `logId`. Client gets real SSE progress. `logRecovery.service.js` deleted entirely.
...
- v1 webhook handlers serve a migration banner after v2 launch

**Sunset**
- v1 stays live 60 days post-launch as fallback
- After 60 days, v1 decommissioned
