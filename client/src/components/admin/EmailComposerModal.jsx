                      ...
                      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                          ...
                          <p className="mt-1 text-sm text-slate-500">
                            Pick exactly who should receive this update before
                            you send it.
                          </p>
                        </div>
                  ...
                  >
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                      <p className="text-sm text-slate-500">
                        Add granular changes to this update
                      </p>
                      <button
                    ...
                    <div className="flex gap-4 rounded-[1.5rem] border border-blue-100 bg-blue-50/60 p-4 sm:p-6">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-700/70">
                          You are about to send this update to{" "}
                          {selectedRecipientIds.length} selected recipients.
                          Double check the copy and the audience before you
                          continue.
                        </p>
                      </div>
                    </div>
