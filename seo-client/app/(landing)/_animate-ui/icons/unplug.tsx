...
import {
  ...
  IconWrapper,
} from "@/app/(landing)/_animate-ui/icons/icon";
...
function IconComponent({ size, ...props }: { size?: number; [key: string]: unknown }) {
  ...
  return (
    <motion.svg
      ...
      {...props}
    >
      <motion.path d="m19 5 3-3" variants={variants.path1 as never} initial="initial" animate={controls} />
      <motion.path d="m12 6 6 6 2.3-2.3a2.4 2.4 0 0 0 0-3.4l-2.6-2.6a2.4 2.4 0 0 0-3.4 0Z" variants={variants.path2 as never} initial="initial" animate={controls} />
      <motion.path d="m2 22 3-3" variants={variants.path3 as never} initial="initial" animate={controls} />
      <motion.path d="M6.3 20.3a2.4 2.4 0 0 0 3.4 0L12 18l-6-6-2.3 2.3a2.4 2.4 0 0 0 0 3.4Z" variants={variants.path4 as never} initial="initial" animate={controls} />
      <motion.path d="M7.5 13.5 10 11" variants={variants.path5 as never} initial="initial" animate={controls} />
      <motion.path d="M10.5 16.5 13 14" variants={variants.path6 as never} initial="initial" animate={controls} />
    </motion.svg>
  );
}

function Unplug(props: Record<string, unknown>) {
